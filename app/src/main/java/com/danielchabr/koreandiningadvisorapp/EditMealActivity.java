...
public class EditMealActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ratingBar = (RatingBar) findViewById(R.id.insert_meal_ratingBar);
        spinner = (Spinner) findViewById(R.id.spiciness);
    ...
    private void loadMealIntoView() {
        ...
        transliteratedName.setText(meal.getTransliteratedName());
        englishName.setText(meal.getEnglishName());
        description.setText(meal.getDescription());
        ratingBar.setRating(meal.getRating());
        spinner.setSelection(meal.getSpicyGrade() + 1);
        ...
        if (meal.getCategory() != null) {
            for (int i = 0; i < categoriesView.getChildCount(); i++) {
                ...
                if (meal.getCategory().lastIndexOf(checkBox.getText().toString()) != -1) {
        ...
        if (meal.hasPhotoLocal()) {
            ...
            if (bitmap == null) {
                mealPhotoView.setImageBitmap(meal.loadPhoto(this));
            } else {
                mealPhotoView.setImageBitmap(bitmap);
            }
        } else if (meal.hasPhoto()) {
            Picasso.with(this).load(ApiClient.getImageUrl() + meal.getPhotoUrl()).into(mealPhotoView);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            final String TAG = "EditMeal";
            Call call = apiClient.getMealService().edit(meal.getId(), meal);
            ...
            call.enqueue(new Callback() {
                ...
                public void onResponse(Response response, Retrofit retrofit) {
                    ...
                    if (response.isSuccess()) {
                        ...
                        showDashboard.putExtra("editedMeal", Parcels.wrap(meal));
